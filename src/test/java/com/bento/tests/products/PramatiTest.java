...
public class PramatiTest  extends BaseTestCase {

	protected static final Logger logger = LogManager.getLogger(PramatiTest.class);
	...
	public void verifyAddProductSuccess() {
		logger.info("1.Launch pramati url");
		...
		adminLoginPage.loginLink.click();
